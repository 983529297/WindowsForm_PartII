...
namespace UnitTestDrawing
{
    public class Robot
    {
        ...
        public void Initialize(string targetAppPath, string root)
        {
            ...
            options.AddAdditionalCapability("ms:waitForAppLaunch", 1);
            options.AddAdditionalCapability("appWorkingDir", "D:/Mydata/視窗程式設計/Drawing/DrawingForm/bin/Debug/");
        ...
        //test
        public void DragAndDrop(string name, float x1, float y1, float x2, float y2)
        {
            ...
            action.ClickAndHold();
            action.MoveByOffset((int)x2, (int)y2);
            action.Release();
            action.Perform();
        }
        ...
        // test
        public void ClickRedoUndo(string name)
        {
